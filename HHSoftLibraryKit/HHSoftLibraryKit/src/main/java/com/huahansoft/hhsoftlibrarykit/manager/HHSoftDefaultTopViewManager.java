...
import com.huahansoft.hhsoftlibrarykit.model.HHSoftTopViewInfo;
...
public final class HHSoftDefaultTopViewManager {
    ...
    public HHSoftDefaultTopViewManager(FragmentActivity activity) {
        this.mActivity = activity;
        this.mIsShowStatusBar = false;
        initView();
    }

    public HHSoftDefaultTopViewManager(HHSoftBaseActivity activity, boolean isShowStatusBar) {
        this.mActivity = activity;
