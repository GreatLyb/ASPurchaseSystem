...
public class HHSoftProgressLoadViewManager implements HHSoftLoadViewInterface {
    /*布局及控件*/
    ...
    //构造方法
    public HHSoftProgressLoadViewManager(Context context, View parentView, HHSoftLoadViewManager.IPageLoad pageLoad) {
        super();
