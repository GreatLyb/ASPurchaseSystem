...
import com.huahansoft.hhsoftlibrarykit.third.HHSoftThirdLoginInfo;

public class HHSoftWeChatUserInfo implements HHSoftThirdLoginInfo {
    ...
    //privilege	用户特权信息，json数组，如微信沃卡用户为（chinaunicom）暂时不用
