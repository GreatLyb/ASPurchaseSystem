package com.lyb.qrcodelibrary.view;
 ...
 * 类传参：
 *
 * @Author： create by Lyb on 2020-04-10 10:43
 */
public class ScanView extends View {
    ...
    private int mScanAnimatorDuration = 2200;//值动画的时长
    ...
    private void init() {
        ...
        mScancolor = resources.getColor(R.color.scan_color);
