...
import com.lysoft.baseproject.activity.BaseUILoadFragment;
...
public abstract class WareHouseListFragment<T> extends BaseUILoadFragment {
    ...
    protected void onCreate() {
        ...
        View view = View.inflate(getPageContext(), R.layout.frag_ware_house_list, null);
        mListView = view.findViewById(R.id.list_warehouse);
//        mListView = new HHSoftRefreshListView(getPageContext());
        ...
        containerView().addView(view, new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
