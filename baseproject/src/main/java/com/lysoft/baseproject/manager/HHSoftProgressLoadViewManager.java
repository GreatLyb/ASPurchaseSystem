...
public class HHSoftProgressLoadViewManager implements LoadViewInterface {
    /*布局及控件*/
    ...
    //构造方法
    public HHSoftProgressLoadViewManager(Context context, View parentView, LoadViewManager.IPageLoad pageLoad) {
        super();
