...
public class MyJzvdStd extends JzvdStd {
    ...
    private OnVideoPlayCompleteListener videoPlayCompleteListener;
    ...
    public void onStateAutoComplete() {
        ...
        if (videoPlayCompleteListener != null) {
            videoPlayCompleteListener.onVideoPlayComplete();
        }
    }
    ...
    public void setVideoPlayCompleteListener(OnVideoPlayCompleteListener videoPlayCompleteListener) {
