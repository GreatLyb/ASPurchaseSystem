...
import com.lysoft.baseproject.utils.BitmapUtils;
...
public class ClipViewLayout extends RelativeLayout {
    ...
    public void initSrcPic(Uri uri) {
        ...
        int[] imageWidthHeight = BitmapUtils.getImageWidthHeight(path);
        int w = imageWidthHeight[0];
        int h = imageWidthHeight[1];

        Bitmap bitmap = BitmapUtils.decodeSampledBitmap(path, w > mWidthPixels ? mWidthPixels : w, h > mHeightPixels ? mHeightPixels : h);
