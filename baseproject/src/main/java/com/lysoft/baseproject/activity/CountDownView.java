...
import com.lysoft.baseproject.utils.SpanUtils;
...
public class CountDownView extends View {
    ...
    public CountDownView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mRingColor = a.getColor(R.styleable.CountDownView_ringColor, context.getResources().getColor(R.color.orange));
        mRingWidth = a.getFloat(R.styleable.CountDownView_ringWidth, 6);
        mRingProgessTextSize = a.getDimensionPixelSize(R.styleable.CountDownView_progressTextSize, DensityUtils.sp2px(context, 14));
        mProgessTextColor = a.getColor(R.styleable.CountDownView_progressTextColor, context.getResources().getColor(R.color.orange));
        mCountdownTime = a.getInteger(R.styleable.CountDownView_countdownTime, 40);
        a.recycle();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //文字居中显示
        canvas.drawCircle(mRectF.centerX(), mRectF.centerY(), mHeight / 2 - 20, circlepaint);
