...
//                log(" ");
    ...
    private Response logForResponse(Response response, long tookMs) {
        ...
        try {
            ...
            log("url== " + clone.code() + ' ' + clone.message() + ' ' + clone.request().url() + getPara(clone.request()) + " (" + tookMs + "ms）");
            if (logHeaders) {
...
//                log(" ");
    ...
    private void bodyToString(Request request) {
        try {
            ...
            log("\tpara==:" + buffer.readString(charset));
        } catch (Exception e) {
            OkLogger.printStackTrace(e);
        }
    }
     ...
     * @return
     */
    private String getPara(Request request) {
        try {
            Request copy = request.newBuilder().build();
            RequestBody body = copy.body();
            if (body == null) {
